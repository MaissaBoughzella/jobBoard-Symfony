 ...
 */
final class Version20200513170027 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD genre VARCHAR(255) NOT NULL, CHANGE category_id category_id INT NOT NULL, CHANGE type_id type_id INT NOT NULL, CHANGE prof prof VARCHAR(255) NOT NULL, CHANGE comp1 comp1 VARCHAR(255) NOT NULL, CHANGE comp2 comp2 VARCHAR(255) NOT NULL, CHANGE comp3 comp3 VARCHAR(255) NOT NULL, CHANGE comp4 comp4 VARCHAR(255) NOT NULL, CHANGE salary salary INT NOT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE education education VARCHAR(255) NOT NULL, CHANGE experience experience VARCHAR(255) NOT NULL, CHANGE description description VARCHAR(255) NOT NULL');
    }
