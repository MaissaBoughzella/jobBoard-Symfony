 ...
 */
final class Version20200520111714 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_2DA17977C54C8C93 ON user (type_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_2DA17977C54C8C93 ON User');
